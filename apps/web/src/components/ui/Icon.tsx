...
const ICONS: Record<string, string> = {
  ...
  fileText: '<path d="M14 3v5h5M16 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M9 13h6M9 17h4"/>',
  ...
  searchX: '<circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5M9 9l4 4M13 9l-4 4"/>',
  ...
  key: '<circle cx="7.5" cy="15.5" r="4.5"/><path d="m10.5 12.5 8-8M16 5l3 3M19 2l3 3"/>',
  ...
  pieChart: '<path d="M21 12A9 9 0 1 1 12 3v9z"/><path d="M21 12a9 9 0 0 0-9-9v9z"/>',
...
export function Icon({ name, size = 18, sw = 2, style, className }: IconProps) {
